!(function (t) {
  'use strict';
  function e(t, e) {
    for (var i in ((e = e || {}), (this.settings = { checkable: 'none' }), e))
      e.hasOwnProperty(i) && (this.settings[i] = e[i]);
    if (
      ((this.button = t),
      this.button.setAttribute('aria-haspopup', !0),
    ...
    var n = function (t, e) {
      var i = e === this.firstItem;
      function n(t) {
        return (i ? t.nextElementSibling : t.previousElementSibling) || e;
      }
      for (var s = n(t); s.disabled; ) s = n(s);
      s.focus();
    }.bind(this);
    Array.prototype.forEach.call(
      this.menuItems,
      function (t) {
        Array.prototype.filter.call(this.menuItems, function (t) {
          return !t.disabled;
        }).length < 1
          ? (this.button.disabled = !0)
          : ('one' === this.settings.checkable
              ? t.setAttribute('role', 'menuitemradio')
              : 'many' === this.settings.checkable
            ...
            t.addEventListener(
              'keydown',
              function (e) {
                40 === e.keyCode && (e.preventDefault(), n(t, this.firstItem)),
                  38 === e.keyCode && (e.preventDefault(), n(t, this.lastItem)),
                  (27 !== e.keyCode && 9 !== e.keyCode) || this.toggle(),
                  27 === e.keyCode && (e.preventDefault(), this.button.focus());
              }.bind(this)
            ),
            t.addEventListener(
              'click',
              function (e) {
                this.choose(t), this.close(), this.button.focus();
              }.bind(this)
            ));
      }.bind(this)
    ),
  ...
  (e.prototype.open = function () {
    if (
      ...
      var t = this.menu.querySelector('[aria-checked="true"]');
    return (
      t
        ? t.focus()
        : this.menu.querySelector('[role^="menuitem"]:not([disabled])').focus(),
      (this.outsideClick = function (t) {
        this.menu.contains(t.target) ||
          this.button.contains(t.target) ||
          (this.close(),
    ...
    (e.prototype.choose = function (t) {
      if (
        ('one' === this.settings.checkable &&
          (Array.prototype.forEach.call(this.menuItems, function (t) {
            t.removeAttribute('aria-checked');
          }),
          t.setAttribute('aria-checked', 'true')),
        'many' === this.settings.checkable)
      ) {
        var e = 'true' === t.getAttribute('aria-checked') || !1;
        t.setAttribute('aria-checked', !e);
      }
      return this._fire('choose', t), this;
    }),
    ...
    'undefined' != typeof module && void 0 !== module.exports
      ...
      : 'object' == typeof t && (t.MenuButton = e);
})(this),
  window.matchMedia('(min-width: 56.25em)').matches
    ? document.querySelectorAll('#menu button').forEach((t) => {
        t.setAttribute('tabindex', '0');
      })
    : new MenuButton(document.querySelector('[data-inclusive-menu-opens]'));
